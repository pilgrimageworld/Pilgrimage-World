...
const Navbar = () => {
  ...
  const destinations = [
    ...
    { name: "Kailash Mansarovar", slug: "kailash-mansarovar" },
    { name: "Vaishno Devi Yatra", slug: "vaishno-devi-yatra" },
    { name: "Amarnath Yatra", slug: "amarnath-yatra" },
    { name: "Varindavan Mathura Yatra", slug: "vrindavan-mathura-yatra" },
    { name: "Golden Temple Yatra", slug: "golden-temple-yatra" },
    { name: "Ayodhya Ram Mandir", slug: "ayodhya-ram-mandir-yatra" },
    { name: "Kashi Vishwanath", slug: "kashi-vishwanath-yatra" },
    { name: "Tirupati Balaji", slug: "tirupati-balaji-yatra" },
    { name: "Shirdi Sai Baba", slug: "shirdi-sai-baba-yatra" },
    { name: "Rameshwaram", slug: "rameshwaram-yatra" },
    { name: "Dwarka Somnath", slug: "dwarka-somnath-yatra" },
    { name: "Ujjain Mahakaleshwar", slug: "ujjain-mahakal-yatra" },
    { name: "Bodh Gaya", slug: "bodh-gaya-buddhist-circuit" },
